...
<div className="flex-1 bg-gradient-to-br from-slate-50 to-blue-50 dark:from-slate-900 dark:to-blue-900/30 dark:to-slate-800 min-w-0">
  <div className="flex flex-row items-center border border-gray-200 dark:border-gray-700 shadow-md rounded-lg justify-between w-full p-4 lg:p-6 dark:bg-slate-800">
   <div className="flex flex-col gap-1">
      ...
      <h3 className="text-gray-400 dark:text-gray-500 text-sm">{trip.startDate} - {trip.endDate}</h3>
      <h3 className="text-gray-400 dark:text-gray-500 text-sm">{trip.members} Members</h3>
    </div>
    <div className="flex flex-col gap-1">
      {isEditable && (
      <div onClick={goback}
...
<div className="flex flex-col lg:flex-row items-stretch lg:items-center gap-2 mb-6 lg:mb-10 border border-gray-300 dark:border-gray-600 mt-4 rounded-[2rem] shadow-md px-4 py-2 dark:bg-slate-800">
...
<div className="flex flex-col justify-between mx-4 space-y-4">
            ...
            <div className=" bg-white dark:bg-slate-800 w-full p-6 rounded-[2rem] mr-3 shadow-md shadow-gray-400 dark:shadow-slate-700">
              ...
              <h4 className="font-bold mt-1  text-gray-900 dark:text-gray-100 mb-2">Collaborators</h4>
              </div>
             <div className="border border-gray-200 dark:border-gray-700 rounded-[2rem] p-2 flex flex-col">
             {(trip?.collaborators || []).map((member) => (
                <div key={member.id} className="flex items-center justify-between rounded-2xl px-4 py-3">
                    <div className="flex items-center gap-3">
        <div className="w-9 h-9 rounded-full bg-blue-600 dark:bg-blue-500 text-white flex items-center justify-center font-bold">
          {member.user.name[0]}
        </div>
...
<div className="mt-4">
  ...
  <button
    ...
    className="w-full border-2 border-blue-300 dark:border-blue-500 rounded-[2rem]
    py-4 flex items-center justify-center gap-2
    text-blue-600 dark:text-blue-400 font-semibold hover:bg-blue-50 dark:hover:bg-blue-900/30 transition cursor-pointer"
  > 
    <Plus size={18} />
    Add Member
  </button>
...
{isAdmin && showSearch && (
  <div className="fixed inset-0 bg-black/20 dark:bg-black/50 flex items-center justify-center z-50">
    ...
    <div className="bg-white dark:bg-slate-800 w-[90vw] max-w-[400px] rounded-[2rem] p-6 shadow-2xl border border-gray-200 dark:border-gray-700">
      ...
      >
        Add
            ...
            <div className="flex flex-col lg:flex-row w-full mr-3 justify-between gap-3 lg:gap-0">
              ...
              <button 
              onClick={saveDraft}
                className="border-2 border-blue-600 dark:border-blue-500 text-gray-700 dark:text-gray-200 font-semibold text-sm px-3 py-3 rounded-[2rem] bg-white dark:bg-slate-800 shadow-md shadow-gray-400 dark:shadow-slate-700 hover:-translate-y-1 transition duration-300 cursor-pointer">
                Save as Draft
              </button>
              )}
